...
public class PackageTest extends PulpTestScript {
	...
	public List<List<Object>> getLocalRepoData() {
		...
		repoOpts.add("--id=package_test_repo");
	...
	public List<List<Object>> getUnsignedPkgData() {
		ArrayList<List<Object>> data = new ArrayList<List<Object>>();
		data.add(Arrays.asList(new Object[]{"unsigned-1.0-1.noarch.rpm", System.getProperty("automation.resources.location") + "unsigned-1.0-1.noarch.rpm", tmpRpmDir, "unsigned"}));
		return data;
	}
