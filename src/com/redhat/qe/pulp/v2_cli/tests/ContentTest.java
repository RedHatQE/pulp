...
public class ContentTest extends PulpTestScript {
	...
	public List<List<Object>> getLocalPkgData() {
		ArrayList<List<Object>> data = new ArrayList<List<Object>>();
		data.add(Arrays.asList(new Object[]{"parent-1.0-1.noarch.rpm", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/updates/parent-1.0-1.noarch.rpm", tmpRpmDir, "parent-1.0-1.noarch.rpm", false}));
		data.add(Arrays.asList(new Object[]{"origin-1.0-1.noarch.rpm", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/updates/origin-1.0-1.noarch.rpm", tmpRpmDir, "origin-1.0-1.noarch.rpm", false}));
		data.add(Arrays.asList(new Object[]{"feedless-1.0-1.noarch.rpm", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/updates/feedless-1.0-1.noarch.rpm", tmpRpmDir, "feedless-1.0-1.noarch.rpm", false}));
		data.add(Arrays.asList(new Object[]{"patb-0.1-1.noarch.rpm", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/patb-0.1-1.noarch.rpm", tmpRpmDir, "patb-0.1-1.noarch.rpm", true}));
		data.add(Arrays.asList(new Object[]{"emoticons-0.1-1.noarch.rpm", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/emoticons-0.1-1.noarch.rpm", tmpRpmDir, "emoticons-0.1-1.noarch.rpm", true}));
		data.add(Arrays.asList(new Object[]{"patb-0.1-2.noarch.rpm", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/updates/patb-0.1-2.noarch.rpm", tmpRpmDir, "patb-0.1-2.noarch.rpm", true}));
		data.add(Arrays.asList(new Object[]{"emoticons-0.1-2.noarch.rpm", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/updates/emoticons-0.1-2.noarch.rpm", tmpRpmDir, "emoticons-0.1-2.noarch.rpm", true}));
		return data;
	}
	...
	public List<List<Object>> getLocalContentData() {
		ArrayList<List<Object>> data = new ArrayList<List<Object>>();
		data.add(Arrays.asList(new Object[]{"dummy_content.csv", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/dummy_content.csv", tmpRpmDir, "dummy_content", false}));
		data.add(Arrays.asList(new Object[]{"test_content-0.1-0.csv", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/test_content-0.1-0.csv", tmpRpmDir, "test_content", true}));
		data.add(Arrays.asList(new Object[]{"test_content-0.1-1.csv", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/test_content-0.1-1.csv", tmpRpmDir, "test_content", true}));
		return data;
	}
	...
	public List<List<Object>> getLocalCSVData() {
		ArrayList<List<Object>> data = new ArrayList<List<Object>>();
		data.add(Arrays.asList(new Object[]{"package.csv", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/", tmpRpmDir}));
		data.add(Arrays.asList(new Object[]{"content.csv", "http://qeblade20.rhq.lab.eng.bos.redhat.com/pub/", tmpRpmDir}));
		// Mix n Match?
		return data;
	}
